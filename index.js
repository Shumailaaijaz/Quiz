...
let quiz = await inquirer.prompt([
    {
        ...
        choices: ['A) super set of javescript', 'B) Dynamic typing', 'C) No typing system', 'D) Weakly-typed system']
    },
    {
        name: 'q2',
        type: 'list',
    ...
    },
    {
        ...
        choices: ['A) Start()', 'B) Prompt()', 'C) Run()', 'D) Ask()']
    },
    {
        name: 'q10',
        type: 'list',
...
if (answer1 === 'A) super set of javescript') {
    score = score + 1;
...
if (answer6 === 'A) to declare a new data type') {
    score = score + 1;
    console.log(chalk.greenBright.bold.italic(`6 : ✅✅✅...Correct Answer...✅✅✅`));
}
else {
    console.log(chalk.redBright.bold.italic(`6 : ❌❌❌...Incorrect Answer...❌❌❌`));
}
;
if (answer7 === 'C) using the const keyword') {
    score = score + 1;
    console.log(chalk.greenBright.bold.italic(`7 : ✅✅✅...Correct Answer...✅✅✅`));
}
else {
    console.log(chalk.redBright.bold.italic(`7 : ❌❌❌...Incorrect Answer...❌❌❌`));
}
;
if (answer8 === 'B) It compiles down to JavaScript') {
    score = score + 1;
    console.log(chalk.greenBright.bold.italic(`8 : ✅✅✅...Correct Answer...✅✅✅`));
}
else {
    console.log(chalk.redBright.bold.italic(`8 : ❌❌❌...Incorrect Answer...❌❌❌`));
}
;
if (answer9 === 'B) Prompt()') {
    score = score + 1;
    console.log(chalk.greenBright.bold.italic(`9 : ✅✅✅...Correct Answer...✅✅✅`));
}
else {
    console.log(chalk.redBright.bold.italic(`9 : ❌❌❌...Incorrect Answer...❌❌❌`));
}
;
if (answer10 === 'A) Strict Mode') {
    score = score + 1;
    console.log(chalk.greenBright.bold.italic(`10 : ✅✅✅...Correct Answer...✅✅✅`));
}
else {
    console.log(chalk.redBright.bold.italic(`10 : ❌❌❌...Incorrect Answer...❌❌❌`));
}
;
if (score <= 5) {
    console.log(chalk.bgMagentaBright.italic.bold(`Your score is  ${score} out of 10😭😭😭!! !!😭😭😭 You needs more practice`));
}
if (score > 5) {
    console.log(chalk.bgGreenBright.italic.bold(`Your score is ${score} out of 10 🤩🤩🤩!! !!🤩🤩🤩 Welldone! Keep it up`));
}
